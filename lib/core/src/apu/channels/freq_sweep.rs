...
/// Represents a frequency sweep mechanism typically within the sound emulation.
/// Based on its parameters, this will periodically adjust the channel frequency.
