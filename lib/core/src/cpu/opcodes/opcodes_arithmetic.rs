...
pub mod inc {
    ...
    /// Increments a value.
    /// (r16) <- (r16) + 1
    fn increment_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16_ptr: RegisterR16) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
...
pub mod dec {
    ...
    /// Decrements a value.
    /// (r16) <- (r16) - 1
    fn decrement_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16_ptr: RegisterR16) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(ec, address);
...
pub mod add {
    ...
    fn add_r8_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8, add_carry: bool) {
    ...
    fn add_r8_r8(dev: &mut EmulatorDevice, _ec: &mut impl EmulatorContextMut, dst: RegisterR8, src: RegisterR8, add_carry: bool) {
    ...
    fn add_r8_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8, src_ptr: RegisterR16, add_carry: bool) {
...
pub mod sub {
    ...
    /// Adds two values and stores it into a 8bit register.
    /// dst <- dst + u8 + (carry flag, if add_carry)
    fn sub_r8_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8, add_carry: bool) {
        let value = dev.cpu.fetch_u8(ec);
    ...
    fn sub_r8_r8(dev: &mut EmulatorDevice, _ec: &mut impl EmulatorContextMut, dst: RegisterR8, src: RegisterR8, sub_carry: bool) {
        let value = dev.cpu.get_r8(src);
    ...
    fn sub_r8_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8, src_ptr: RegisterR16, sub_carry: bool) {
        let address = dev.cpu.get_r16(src_ptr);
        let value   = dev.get_mmu().read_u8(ec, address);
        sub_r8_u8v(dev, dst, value, sub_carry);
    }
...
pub mod rl {
    ...
    fn shift_left_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16, op: ShiftOp) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
    ...
    fn sla_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
    ...
    fn rl_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
    ...
    fn rlc_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
...
pub mod rr {
    ...
    fn shift_right_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16, op: ShiftOp) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16ptr);
                let value   = dev.get_mmu().read_u8(ec, address);
    ...
    fn sra_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
    ...
    /// Performs an arithmetic shift right of the value on a memory location.
    fn srl_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
    ...
    fn rr_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
    ...
    fn rrc_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
...
pub mod swap {
    ...
    fn swap_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16_ptr: RegisterR16) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(ec, address);
...
pub mod set_bit {
    ...
    /// (r16) <- (r16) | (1 << bit)
    fn set_bit_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16_ptr: RegisterR16, bit: u8) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(ec, address);
...
pub mod res_bit {
    ...
    /// (r16) <- (r16) & !(1 << bit)
    fn res_bit_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, ctx: &mut OpCodeContext, r16_ptr: RegisterR16, bit: u8) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(ec, address);
...
pub mod chk_bit {
    ...
    /// Set the Zero flag, if the bit was 0.
    fn check_bit_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, r16_ptr: RegisterR16, bit: u8) {
        let address = dev.cpu.get_r16(r16_ptr);
        let value   = dev.get_mmu().read_u8(ec, address);
        check_bit_u8v(dev, value, bit);
    }
...
pub mod cp {
    ...
    /// Compares two values.
    /// cp r8, u8
    fn cp_r8_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, r8: RegisterR8) {
    ...
    /// Compares two values.
    /// cp dst, src
    fn cp_r8_r8(dev: &mut EmulatorDevice, _ec: &mut impl EmulatorContextMut, dst: RegisterR8, src: RegisterR8) {
    ...
    /// Compares two values.
    /// cp dst, (src_ptr)
    fn cp_r8_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8, src_ptr: RegisterR16) {
        let value1  = dev.cpu.get_r8(dst);
        let address = dev.cpu.get_r16(src_ptr);
...
pub mod and {
    ...
    /// Computes a bitwise AND.
    /// dst <- dst & u8
    fn and_r8_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8) {
        let value = dev.cpu.fetch_u8(ec);
    ...
    /// Computes a bitwise AND.
    /// dst <- dst & src
    fn and_r8_r8(dev: &mut EmulatorDevice, _ec: &mut impl EmulatorContextMut, dst: RegisterR8, src: RegisterR8) {
        let value = dev.cpu.get_r8(src);
        and_r8_u8v(dev, dst, value);
    }
    ...
    /// Computes a bitwise AND.
    /// dst <- dst & (src_ptr)
    fn and_r8_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8, src_ptr: RegisterR16) {
        let address = dev.cpu.get_r16(src_ptr);
        let value   = dev.get_mmu().read_u8(ec, address);
        and_r8_u8v(dev, dst, value);
    }
...
pub mod or {
    ...
    /// Computes a bitwise OR.
    /// dst <- dst | u8
    fn or_r8_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8) {
        let value = dev.cpu.fetch_u8(ec);
    ...
    /// Computes a bitwise OR.
    /// dst <- dst | src
    fn or_r8_r8(dev: &mut EmulatorDevice, _ec: &mut impl EmulatorContextMut, dst: RegisterR8, src: RegisterR8) {
        let value = dev.cpu.get_r8(src);
        or_r8_u8v(dev, dst, value);
    }
    ...
    /// Computes a bitwise OR.
    /// dst <- dst | (src_ptr)
    fn or_r8_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8, src_ptr: RegisterR16) {
        let address = dev.cpu.get_r16(src_ptr);
        let value   = dev.get_mmu().read_u8(ec, address);
        or_r8_u8v(dev, dst, value);
    }
...
pub mod xor {
    ...
    /// Computes a bitwise XOR.
    /// dst <- dst ^ src
    fn xor_r8_r8(dev: &mut EmulatorDevice, _ec: &mut impl EmulatorContextMut, dst: RegisterR8, src: RegisterR8) {
        let value = dev.cpu.get_r8(src);
    ...
    /// Computes a bitwise XOR.
    /// dst <- dst ^ (src_ptr)
    fn xor_r8_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, dst: RegisterR8, src_ptr: RegisterR16) {
        let address = dev.cpu.get_r16(src_ptr);
        let value   = dev.get_mmu().read_u8(ec, address);
        xor_r8_u8v(dev, dst, value);
    }
    ...
    fn xor_r8_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorContextMut, r8: RegisterR8) {
        let value = dev.cpu.fetch_u8(ec);
