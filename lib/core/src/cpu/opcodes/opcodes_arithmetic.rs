...
pub mod inc {
    ...
    /// Increments a value.
    /// (r16) <- (r16) + 1
    fn increment_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16_ptr: RegisterR16) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(address);
            ...
            1 => {
                ...
                let result  = increment_u8v(dev, value);
                dev.get_mmu_mut().write_u8(address, result);
    ...
    // INC (r16)
    opcode!(inc_hlptr, [dev, ctx] increment_r16ptr(dev, ctx, RegisterR16::HL));
...
pub mod dec {
    ...
    /// Decrements a value.
    /// (r16) <- (r16) - 1
    fn decrement_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16_ptr: RegisterR16) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(address);
    ...
    // DEC (r16)
    opcode!(dec_hlptr, [dev, ctx] decrement_r16ptr(dev, ctx, RegisterR16::HL));
...
pub mod add {
    ...
    fn add_r8_u8v(dev: &mut EmulatorDevice, r8: RegisterR8, value: u8, add_carry: bool) {
        ...
        dev.cpu.set_r8(r8, result as u8);
    }

    /// Adds two values and stores it into a 8bit register.
    /// dst <- dst + u8 + (carry flag, if add_carry)
    fn add_r8_u8(dev: &mut EmulatorDevice, dst: RegisterR8, add_carry: bool) {
        let value = dev.cpu.fetch_u8();
        add_r8_u8v(dev, dst, value, add_carry);
    }

    /// Adds two values and stores it into a 8bit register.
    /// dst <- dst + src + (carry flag, if add_carry)
    fn add_r8_r8(dev: &mut EmulatorDevice, dst: RegisterR8, src: RegisterR8, add_carry: bool) {
    ...
    fn add_r8_r16ptr(dev: &mut EmulatorDevice, dst: RegisterR8, src_ptr: RegisterR16, add_carry: bool) {
    ...
    fn add_r16_u16v(dev: &mut EmulatorDevice, r16: RegisterR16, value: u16) {
        ...
        dev.cpu.set_flag(CpuFlag::HalfCarry, half_carry);
        dev.cpu.set_flag(CpuFlag::Carry, carry);
        dev.cpu.set_r16(r16, result as u16);
    }
    ...
    // ADD r8, ?
    opcode!(add_a_u8,    [dev] add_r8_u8(dev, RegisterR8::A, false));
    opcode!(add_a_a,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::A, false));
    opcode!(add_a_b,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::B, false));
    opcode!(add_a_c,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::C, false));
    opcode!(add_a_d,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::D, false));
    opcode!(add_a_e,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::E, false));
    opcode!(add_a_h,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::H, false));
    opcode!(add_a_l,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::L, false));
    opcode!(add_a_hlptr, [dev] add_r8_r16ptr(dev, RegisterR8::A, RegisterR16::HL, false));

    // add with carry flag
    // ADC r8, ?
    opcode!(adc_a_u8,    [dev] add_r8_u8(dev, RegisterR8::A, true));
    opcode!(adc_a_a,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::A, true));
    opcode!(adc_a_b,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::B, true));
    opcode!(adc_a_c,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::C, true));
    opcode!(adc_a_d,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::D, true));
    opcode!(adc_a_e,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::E, true));
    opcode!(adc_a_h,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::H, true));
    opcode!(adc_a_l,     [dev] add_r8_r8(dev, RegisterR8::A, RegisterR8::L, true));
    opcode!(adc_a_hlptr, [dev] add_r8_r16ptr(dev, RegisterR8::A, RegisterR16::HL, true));
...
pub mod sub {
    ...
    /// Adds two values and stores it into a 8bit register.
    /// dst <- dst + u8 + (carry flag, if add_carry)
    fn sub_r8_u8(dev: &mut EmulatorDevice, dst: RegisterR8, add_carry: bool) {
        let value = dev.cpu.fetch_u8();
    ...
    fn sub_r8_r8(dev: &mut EmulatorDevice, dst: RegisterR8, src: RegisterR8, sub_carry: bool) {
        let value = dev.cpu.get_r8(src);
    ...
    fn sub_r8_r16ptr(dev: &mut EmulatorDevice, dst: RegisterR8, src_ptr: RegisterR16, sub_carry: bool) {
        let address = dev.cpu.get_r16(src_ptr);
        let value   = dev.get_mmu().read_u8(address);
        sub_r8_u8v(dev, dst, value, sub_carry);
    }
    ...
    // SUB r8, ?
    opcode!(sub_a_u8,    [dev] sub_r8_u8(dev, RegisterR8::A, false));
    opcode!(sub_a_a,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::A, false));
    opcode!(sub_a_b,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::B, false));
    opcode!(sub_a_c,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::C, false));
    opcode!(sub_a_d,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::D, false));
    opcode!(sub_a_e,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::E, false));
    opcode!(sub_a_h,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::H, false));
    opcode!(sub_a_l,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::L, false));
    opcode!(sub_a_hlptr, [dev] sub_r8_r16ptr(dev, RegisterR8::A, RegisterR16::HL, false));

    // subtract with carry flag
    // SUB r8, ?
    opcode!(sbc_a_u8,    [dev] sub_r8_u8(dev, RegisterR8::A, true));
    opcode!(sbc_a_a,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::A, true));
    opcode!(sbc_a_b,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::B, true));
    opcode!(sbc_a_c,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::C, true));
    opcode!(sbc_a_d,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::D, true));
    opcode!(sbc_a_e,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::E, true));
    opcode!(sbc_a_h,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::H, true));
    opcode!(sbc_a_l,     [dev] sub_r8_r8(dev, RegisterR8::A, RegisterR8::L, true));
    opcode!(sbc_a_hlptr, [dev] sub_r8_r16ptr(dev, RegisterR8::A, RegisterR16::HL, true));
}
...
pub mod rl {
    ...
    fn shift_left_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16, op: ShiftOp) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
    ...
    fn sla_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
        shift_left_r16ptr(dev, ctx, r16ptr, ShiftOp::ShiftArithmetic)
    }
    ...
    fn rl_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
        shift_left_r16ptr(dev, ctx, r16ptr, ShiftOp::RotateThroughCarry)
    }
    ...
    fn rlc_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
        shift_left_r16ptr(dev, ctx, r16ptr, ShiftOp::Rotate)
    }
    ...
    opcode!(sla_hlptr, [dev, ctx] sla_r16ptr(dev, ctx, RegisterR16::HL));
    opcode!(rl_hlptr,  [dev, ctx] rl_r16ptr (dev, ctx, RegisterR16::HL));
    opcode!(rlc_hlptr, [dev, ctx] rlc_r16ptr(dev, ctx, RegisterR16::HL));
}
...
pub mod rr {
    ...
    fn shift_right_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16, op: ShiftOp) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16ptr);
                let value   = dev.get_mmu().read_u8(address);
    ...
    fn sra_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
        shift_right_r16ptr(dev, ctx, r16ptr, ShiftOp::ShiftArithmetic)
    }
    ...
    /// Performs an arithmetic shift right of the value on a memory location.
    fn srl_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
        shift_right_r16ptr(dev, ctx, r16ptr, ShiftOp::ShiftLogical)
    }
    ...
    fn rr_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
        shift_right_r16ptr(dev, ctx, r16ptr, ShiftOp::RotateThroughCarry)
    }
    ...
    fn rrc_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16ptr: RegisterR16) -> OpCodeResult {
        shift_right_r16ptr(dev, ctx, r16ptr, ShiftOp::Rotate)
    }
    ...
    opcode!(sra_hlptr, [dev, ctx] sra_r16ptr(dev, ctx, RegisterR16::HL));
    opcode!(srl_hlptr, [dev, ctx] srl_r16ptr(dev, ctx, RegisterR16::HL));
    opcode!(rr_hlptr,  [dev, ctx] rr_r16ptr (dev, ctx, RegisterR16::HL));
    opcode!(rrc_hlptr, [dev, ctx] rrc_r16ptr(dev, ctx, RegisterR16::HL));
}
...
pub mod swap {
    ...
    fn swap_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16_ptr: RegisterR16) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(address);
    ...
    opcode!(swap_hlptr, [dev, ctx] swap_r16ptr(dev, ctx, RegisterR16::HL));
}
...
pub mod set_bit {
    ...
    /// (r16) <- (r16) | (1 << bit)
    fn set_bit_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16_ptr: RegisterR16, bit: u8) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(address);
    ...
    opcode!(set_bit_0_hlptr, [dev, ctx] set_bit_r16ptr(dev, ctx, RegisterR16::HL, 0));
    opcode!(set_bit_1_hlptr, [dev, ctx] set_bit_r16ptr(dev, ctx, RegisterR16::HL, 1));
    opcode!(set_bit_2_hlptr, [dev, ctx] set_bit_r16ptr(dev, ctx, RegisterR16::HL, 2));
    opcode!(set_bit_3_hlptr, [dev, ctx] set_bit_r16ptr(dev, ctx, RegisterR16::HL, 3));
    opcode!(set_bit_4_hlptr, [dev, ctx] set_bit_r16ptr(dev, ctx, RegisterR16::HL, 4));
    opcode!(set_bit_5_hlptr, [dev, ctx] set_bit_r16ptr(dev, ctx, RegisterR16::HL, 5));
    opcode!(set_bit_6_hlptr, [dev, ctx] set_bit_r16ptr(dev, ctx, RegisterR16::HL, 6));
    opcode!(set_bit_7_hlptr, [dev, ctx] set_bit_r16ptr(dev, ctx, RegisterR16::HL, 7));
}
...
pub mod res_bit {
    ...
    /// (r16) <- (r16) & !(1 << bit)
    fn res_bit_r16ptr(dev: &mut EmulatorDevice, ctx: &mut OpCodeContext, r16_ptr: RegisterR16, bit: u8) -> OpCodeResult {
        match ctx.get_stage() {
            0 => {
                let address = dev.cpu.get_r16(r16_ptr);
                let value   = dev.get_mmu().read_u8(address);
    ...
    opcode!(res_bit_0_hlptr, [dev, ctx] res_bit_r16ptr(dev, ctx, RegisterR16::HL, 0));
    opcode!(res_bit_1_hlptr, [dev, ctx] res_bit_r16ptr(dev, ctx, RegisterR16::HL, 1));
    opcode!(res_bit_2_hlptr, [dev, ctx] res_bit_r16ptr(dev, ctx, RegisterR16::HL, 2));
    opcode!(res_bit_3_hlptr, [dev, ctx] res_bit_r16ptr(dev, ctx, RegisterR16::HL, 3));
    opcode!(res_bit_4_hlptr, [dev, ctx] res_bit_r16ptr(dev, ctx, RegisterR16::HL, 4));
    opcode!(res_bit_5_hlptr, [dev, ctx] res_bit_r16ptr(dev, ctx, RegisterR16::HL, 5));
    opcode!(res_bit_6_hlptr, [dev, ctx] res_bit_r16ptr(dev, ctx, RegisterR16::HL, 6));
    opcode!(res_bit_7_hlptr, [dev, ctx] res_bit_r16ptr(dev, ctx, RegisterR16::HL, 7));
}
...
pub mod chk_bit {
    ...
    /// Set the Zero flag, if the bit was 0.
    fn check_bit_r16ptr(dev: &mut EmulatorDevice, r16_ptr: RegisterR16, bit: u8) {
        let address = dev.cpu.get_r16(r16_ptr);
        let value   = dev.get_mmu().read_u8(address);
        check_bit_u8v(dev, value, bit);
    }
    ...
    opcode!(check_bit_0_hlptr, [dev] check_bit_r16ptr(dev, RegisterR16::HL, 0));
    ...
    opcode!(check_bit_1_hlptr, [dev] check_bit_r16ptr(dev, RegisterR16::HL, 1));
    ...
    opcode!(check_bit_2_hlptr, [dev] check_bit_r16ptr(dev, RegisterR16::HL, 2));
    ...
    opcode!(check_bit_3_hlptr, [dev] check_bit_r16ptr(dev, RegisterR16::HL, 3));
    ...
    opcode!(check_bit_4_hlptr, [dev] check_bit_r16ptr(dev, RegisterR16::HL, 4));
    ...
    opcode!(check_bit_5_hlptr, [dev] check_bit_r16ptr(dev, RegisterR16::HL, 5));
    ...
    opcode!(check_bit_6_hlptr, [dev] check_bit_r16ptr(dev, RegisterR16::HL, 6));
    ...
    opcode!(check_bit_7_hlptr, [dev] check_bit_r16ptr(dev, RegisterR16::HL, 7));
}
...
pub mod cp {
    ...
    /// Compares two values.
    /// cp r8, u8
    fn cp_r8_u8(dev: &mut EmulatorDevice, r8: RegisterR8) {
        let value1 = dev.cpu.get_r8(r8);
        let value2 = dev.cpu.fetch_u8();
        cp_u8v_u8v(dev, value1, value2);
    }

    /// Compares two values.
    /// cp dst, src
    fn cp_r8_r8(dev: &mut EmulatorDevice, dst: RegisterR8, src: RegisterR8) {
    ...
    /// Compares two values.
    /// cp dst, (src_ptr)
    fn cp_r8_r16ptr(dev: &mut EmulatorDevice, dst: RegisterR8, src_ptr: RegisterR16) {
        let value1  = dev.cpu.get_r8(dst);
        let address = dev.cpu.get_r16(src_ptr);
        let value2  = dev.get_mmu().read_u8(address);
        cp_u8v_u8v(dev, value1, value2);
    }


    opcode!(cp_a_u8,    [dev] cp_r8_u8(dev, RegisterR8::A));
    opcode!(cp_a_a,     [dev] cp_r8_r8(dev, RegisterR8::A, RegisterR8::A));
    opcode!(cp_a_b,     [dev] cp_r8_r8(dev, RegisterR8::A, RegisterR8::B));
    opcode!(cp_a_c,     [dev] cp_r8_r8(dev, RegisterR8::A, RegisterR8::C));
    opcode!(cp_a_d,     [dev] cp_r8_r8(dev, RegisterR8::A, RegisterR8::D));
    opcode!(cp_a_e,     [dev] cp_r8_r8(dev, RegisterR8::A, RegisterR8::E));
    opcode!(cp_a_h,     [dev] cp_r8_r8(dev, RegisterR8::A, RegisterR8::H));
    opcode!(cp_a_l,     [dev] cp_r8_r8(dev, RegisterR8::A, RegisterR8::L));
    opcode!(cp_a_hlptr, [dev] cp_r8_r16ptr(dev, RegisterR8::A, RegisterR16::HL));
}
...
pub mod and {
    ...
    /// Computes a bitwise AND.
    /// dst <- dst & u8
    fn and_r8_u8(dev: &mut EmulatorDevice, dst: RegisterR8) {
        let value = dev.cpu.fetch_u8();
    ...
    /// Computes a bitwise AND.
    /// dst <- dst & src
    fn and_r8_r8(dev: &mut EmulatorDevice, dst: RegisterR8, src: RegisterR8) {
        let value = dev.cpu.get_r8(src);
        and_r8_u8v(dev, dst, value);
    }
    ...
    /// Computes a bitwise AND.
    /// dst <- dst & (src_ptr)
    fn and_r8_r16ptr(dev: &mut EmulatorDevice, dst: RegisterR8, src_ptr: RegisterR16) {
        let address = dev.cpu.get_r16(src_ptr);
        let value   = dev.get_mmu().read_u8(address);
        and_r8_u8v(dev, dst, value);
    }
    ...
    opcode!(and_a_u8,    [dev] and_r8_u8(dev, RegisterR8::A));
    opcode!(and_a_a,     [dev] and_r8_r8(dev, RegisterR8::A, RegisterR8::A));
    opcode!(and_a_b,     [dev] and_r8_r8(dev, RegisterR8::A, RegisterR8::B));
    opcode!(and_a_c,     [dev] and_r8_r8(dev, RegisterR8::A, RegisterR8::C));
    opcode!(and_a_d,     [dev] and_r8_r8(dev, RegisterR8::A, RegisterR8::D));
    opcode!(and_a_e,     [dev] and_r8_r8(dev, RegisterR8::A, RegisterR8::E));
    opcode!(and_a_h,     [dev] and_r8_r8(dev, RegisterR8::A, RegisterR8::H));
    opcode!(and_a_l,     [dev] and_r8_r8(dev, RegisterR8::A, RegisterR8::L));
    opcode!(and_a_hlptr, [dev] and_r8_r16ptr(dev, RegisterR8::A, RegisterR16::HL));
}
...
pub mod or {
    ...
    /// Computes a bitwise OR.
    /// dst <- dst | u8
    fn or_r8_u8(dev: &mut EmulatorDevice, dst: RegisterR8) {
        let value = dev.cpu.fetch_u8();
    ...
    /// Computes a bitwise OR.
    /// dst <- dst | src
    fn or_r8_r8(dev: &mut EmulatorDevice, dst: RegisterR8, src: RegisterR8) {
        let value = dev.cpu.get_r8(src);
        or_r8_u8v(dev, dst, value);
    }
    ...
    /// Computes a bitwise OR.
    /// dst <- dst | (src_ptr)
    fn or_r8_r16ptr(dev: &mut EmulatorDevice, dst: RegisterR8, src_ptr: RegisterR16) {
        let address = dev.cpu.get_r16(src_ptr);
        let value   = dev.get_mmu().read_u8(address);
        or_r8_u8v(dev, dst, value);
    }
    ...
    opcode!(or_a_u8,    [dev] or_r8_u8(dev, RegisterR8::A));
    opcode!(or_a_a,     [dev] or_r8_r8(dev, RegisterR8::A, RegisterR8::A));
    opcode!(or_a_b,     [dev] or_r8_r8(dev, RegisterR8::A, RegisterR8::B));
    opcode!(or_a_c,     [dev] or_r8_r8(dev, RegisterR8::A, RegisterR8::C));
    opcode!(or_a_d,     [dev] or_r8_r8(dev, RegisterR8::A, RegisterR8::D));
    opcode!(or_a_e,     [dev] or_r8_r8(dev, RegisterR8::A, RegisterR8::E));
    opcode!(or_a_h,     [dev] or_r8_r8(dev, RegisterR8::A, RegisterR8::H));
    opcode!(or_a_l,     [dev] or_r8_r8(dev, RegisterR8::A, RegisterR8::L));
    opcode!(or_a_hlptr, [dev] or_r8_r16ptr(dev, RegisterR8::A, RegisterR16::HL));
}
...
pub mod xor {
    ...
    /// Computes a bitwise XOR.
    /// dst <- dst ^ src
    fn xor_r8_r8(dev: &mut EmulatorDevice, dst: RegisterR8, src: RegisterR8) {
        let value = dev.cpu.get_r8(src);
    ...
    /// Computes a bitwise XOR.
    /// dst <- dst ^ (src_ptr)
    fn xor_r8_r16ptr(dev: &mut EmulatorDevice, dst: RegisterR8, src_ptr: RegisterR16) {
        let address = dev.cpu.get_r16(src_ptr);
        let value   = dev.get_mmu().read_u8(address);
        xor_r8_u8v(dev, dst, value);
    }
    ...
    fn xor_r8_u8(dev: &mut EmulatorDevice, r8: RegisterR8) {
        let value = dev.cpu.fetch_u8();
        xor_r8_u8v(dev, r8, value);
    }


    opcode!(xor_a_u8,    [dev] xor_r8_u8(dev, RegisterR8::A));
    opcode!(xor_a_a,     [dev] xor_r8_r8(dev, RegisterR8::A, RegisterR8::A));
    opcode!(xor_a_b,     [dev] xor_r8_r8(dev, RegisterR8::A, RegisterR8::B));
    opcode!(xor_a_c,     [dev] xor_r8_r8(dev, RegisterR8::A, RegisterR8::C));
    opcode!(xor_a_d,     [dev] xor_r8_r8(dev, RegisterR8::A, RegisterR8::D));
    opcode!(xor_a_e,     [dev] xor_r8_r8(dev, RegisterR8::A, RegisterR8::E));
    opcode!(xor_a_h,     [dev] xor_r8_r8(dev, RegisterR8::A, RegisterR8::H));
    opcode!(xor_a_l,     [dev] xor_r8_r8(dev, RegisterR8::A, RegisterR8::L));
    opcode!(xor_a_hlptr, [dev] xor_r8_r16ptr(dev, RegisterR8::A, RegisterR16::HL));
}
