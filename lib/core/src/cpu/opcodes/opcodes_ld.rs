...
fn ld_r8_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR8) {
    let value = dev.cpu.fetch_u8(ec);
    dev.cpu.set_r8(dst, value);
}

/// Loads the content of a 8bit register into the device memory.
fn ld_addr_r8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst_address: u16, src: RegisterR8) {
    let value = dev.cpu.get_r8(src);
    dev.get_mmu_mut().write_u8(ec, dst_address, value);
}

/// Writes a 8bit value to a given address in the device memory.
fn ld_addr_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst_address: u16, value: u8) {
    dev.get_mmu_mut().write_u8(ec, dst_address, value);
}

/// Writes a 8bit value to a given address in the device memory.
fn ld_addr_u16(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst_address: u16, value: u16) {
    dev.get_mmu_mut().write_u16(ec, dst_address, value);
}

/// Loads the value on a given address into a 8bit register.
fn ld_r8_addr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR8, src_address: u16) {
...
fn ld_r16ptr_r8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR16, src: RegisterR8) {
...
fn ld_u16ptr_r8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, src: RegisterR8) {
...
fn ld_r16ptr_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR16) {
    let address = dev.cpu.get_r16(dst);
    let value   = dev.cpu.fetch_u8(ec);
...
fn ld_u16ptr_u16v(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, value: u16) {
    let address = dev.cpu.fetch_u16(ec);
...
fn ld_r8_r16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR8, src: RegisterR16) {
...
/// into a 8bit register.
fn ld_r8_u16ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR8) {
    let address = dev.cpu.fetch_u16(ec);
    ld_r8_addr(dev, ec, dst, address);
}

/// Loads a constant 16bit value from the current instruction pointer into a 16bit register.
fn ld_r16_u16(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR16) {
...
fn ldh_u8_r8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, src: RegisterR8) {
    let value     = dev.cpu.get_r8(src);
...
fn ldh_r8_u8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR8) {
    let address_h = dev.cpu.fetch_u8(ec);
    let address   = 0xff00 | (address_h as u16);
...
fn ldh_r8ptr_r8(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst_ptr: RegisterR8, src: RegisterR8) {
...
fn ldh_r8_r8ptr(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, dst: RegisterR8, src_ptr: RegisterR8) {
...
fn push_r16(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, r16: RegisterR16) {
    let value = dev.cpu.get_r16(r16);
    dev.cpu.push_u16(ec, value);
}

/// Pops a 16bit value from the stack into a 16bit register.
fn pop_r16(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, r16: RegisterR16) {
...
fn pop_r16_mask(dev: &mut EmulatorDevice, ec: &mut impl EmulatorClientMut, r16: RegisterR16, mask: u16) {
    let value = dev.cpu.pop_u16(ec);
